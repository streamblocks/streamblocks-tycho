...
public class TestTypeAnalysis {
	...
	@Test
	public void testTypeAnalysisOnRVCParser() throws AmbiguityException {
		...
		register.register(TreeRootModule.class, NameAnalysis.class, Imports.class, NamespaceDecls.class,
				TypeAnalysis.class, TypeErrors.class, ConstantEvaluation.class);
		AttributeEvaluator eval = register.getEvaluator(root, new IRNodeTraverserWithTreeRoot());
		Set<Message> errors = eval.evaluate("typeErrors", root);
		if (!errors.isEmpty()) {
