...
public class ActorMachineTransformerWrapper<P> extends AbstractActorMachineTransformer<P> implements ActorMachineTransformer<P> {

	private final BasicTransformer<P> inner;

	public ActorMachineTransformerWrapper(BasicTransformer<P> inner) {
		this.inner = inner;
	}
