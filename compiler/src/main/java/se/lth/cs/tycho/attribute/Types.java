...
public interface Types {
    ...
    interface Implementation extends Types {
        ...
        default Type computeType(ExprAvailInput exprAvailInput) {
            return new IntType(OptionalInt.empty(), false);
        }

        default Type computeType(ExprAvailOutput exprAvailOutput) {
            return new IntType(OptionalInt.empty(), false);
        }
        ...
        default Type leastUpperBound(BottomType a, BottomType b) {
            return BottomType.INSTANCE;
        }

        default Type leastUpperBound(BottomType a, Type b) {
            return b;
        }

        default Type leastUpperBound(Type a, BottomType b) {
            return a;
        }
