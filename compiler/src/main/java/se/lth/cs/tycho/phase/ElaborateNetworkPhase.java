...
public class ElaborateNetworkPhase implements Phase {
    ...
    public CompilationTask execute(CompilationTask task, Context context) {
        return task.withNetwork(fullyElaborate(task, context, task.getNetwork(), new HashSet<>()));
    }
    ...
    public Network fullyElaborate(CompilationTask task, Context context, Network network, Set<String> names) {
        ...
        for (Instance instance : result.getInstances()) {
            ...
            if (entity.getEntity() instanceof NlNetwork) {
                ...
                if (context.getConfiguration().get(experimentalNetworkElaboration)) {
                    ...
                    elaborated = elaborate(context, (NlNetwork) entity.getEntity());
                }
                elaborated = fullyElaborate(task, context, elaborated, names);
    ...
    private Network elaborate(Context context, NlNetwork network) {
